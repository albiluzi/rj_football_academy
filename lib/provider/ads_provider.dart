...
class AdsProvider {
  ...
  String getInterstitialLocal() {
    return (prefs.getString("ads_interstitial_local") == null)
        ? "FACEBOOK"
        : prefs.getString("ads_interstitial_local");
  }

  String getBannerLocal() {
    return (prefs.getString("ads_banner_local") == null)
        ? "FACEBOOK"
        : prefs.getString("ads_banner_local");
  }
