...
class NotificationManager {
  ...
  showNotification() async {
    ...
    var platformChannel =
        NotificationDetails(iOS: iOSChannel, android: androidChannel);
  ...
  showNotificationWithAttachment(String _id, String title, String message,
      String image, String icon, String payload) async {
    ...
    if (icon != null && icon != "null") {
      var attachmentIconPath = await _downloadAndSaveFile(
          icon, id.toString() + 'icon_attachment_img.jpg');
      largeIcon = FilePathAndroidBitmap(attachmentIconPath);
    }
    if (image != null && image != "null") {
      var attachmentPicturePath = await _downloadAndSaveFile(
          image, id.toString() + 'attachment_img.jpg');
    ...
    var androidChannelSpecifics = AndroidNotificationDetails(
        id.toString(), "Link_channel", "Link notification",
        importance: Importance.high,
        priority: Priority.high,
        styleInformation: (image != null && image != "null")
            ? notificationPannel
            : notificationPannelText,
        largeIcon: largeIcon,
