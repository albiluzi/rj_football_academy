        ...
        body: SafeArea(
          child: SingleChildScrollView(
            ...
            children: [
              ...
              buildSettingItem(
                  "Report bugs and help", LineIcons.question_circle, () {
                Route route = MaterialPageRoute(
                    builder: (context) => Report(
                        message: "",
                        image: Icon(Icons.mail, size: 100),
                        title: "Report bugs and help",
                        status: -1));
              ...
              buildInfoItem(
                  "App version", LineIcons.info_circle, projectVersion),
            ],
          )),
        ));
  }
              ...
              child: Row(
                  ...
                  children: [
                    Container(
                      height: 30,
                      width: 60,
                      child: Icon(LineIcons.newspaper_o,
                          color: Theme.of(context).textTheme.subtitle1.color,
                          size: 25),
                    ),
                    Expanded(
