          ...
          child: SingleChildScrollView(
              child:Column(
                children: [
                  ...
                  buildSettingItem("Report bugs and help",LineIcons.question_circle,(){
                  ...
                  buildInfoItem("App version",LineIcons.info_circle,projectVersion),
                ],
              )
              ...
              child:Row(
                  ...
                  children: [
                    Container(
                      height: 30,
                      width: 60,
                      child: Icon(LineIcons.newspaper_o,color: Theme.of(context).textTheme.subtitle1.color,size: 25),
