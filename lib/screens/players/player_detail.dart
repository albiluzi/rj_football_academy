...
class _PlayerDetailState extends State<PlayerDetail> {
            ...
            children: [
              Positioned(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        widget.player.fname.toUpperCase(),
                        style: TextStyle(
                      ...
                      Text(
                        widget.player.lname.toUpperCase(),
                        style: TextStyle(
              ...
              Positioned(
                  ...
                  child: Hero(
                    ...
                    child: Image.network(widget.player.image,
        ...
        children: [
          ...
          Positioned(
            ...
            child: Opacity(
              opacity: 0.2,
              child: Text(
                widget.player.number.toUpperCase(),
                style: TextStyle(
                ...
                Row(
                  ...
                  children: [
                    Container(
                      ...
                      child: ClipOval(
                        child: Container(
                          child: Image.network(widget.player.country_image,
                              fit: BoxFit.cover),
                        ),
                      ),
                    ),
                  ...
                  child: Container(
                    child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return buildItem(widget.player.statistics[index].name,
                              widget.player.statistics[index].value);
                        }),
                  ),
                )
              ],
  ...
  Widget buildSocial(String type, String username) {
    ...
    switch (type) {
      ...
      case "website":
        ...
        break;
      case "youtube":
        iconData = LineIcons.youtube_play;
        break;
    }
    return Container(
      decoration: BoxDecoration(
  ...
  buildSocials() {
    return Visibility(
      visible: (widget.player.socials == null)
          ? false
          : (widget.player.socials.length == 0)
              ? false
              : true,
      child: Container(
        ...
        decoration: BoxDecoration(
          border: Border(
            bottom:
                BorderSide(width: 0.2, color: Colors.white.withOpacity(0.3)),
          ),
        ),
        height: 50,
        child: Row(
