...
class _RankingTableState extends State<RankingTable> {
  ...
  Widget buildRowHeader(Header header) {
    ...
    list.add(buildCellHeader(
        flex: 1, text: header.prefix, textAlign: TextAlign.left));
    list.add(buildCellHeader(
        flex: 4, text: header.label, textAlign: TextAlign.left));

    if (widget.table.columns >= 1 && header.row1 != null) {
      list.add(buildCellHeader(
          flex: 1,
          text: (header.row1 != null) ? header.row1 : "#",
          textAlign: TextAlign.center));
    }
    if (widget.table.columns >= 2 && header.row2 != null) {
      list.add(buildCellHeader(
          flex: 1,
          text: (header.row2 != null) ? header.row2 : "#",
          textAlign: TextAlign.center));
    }
    if (widget.table.columns >= 3 && header.row3 != null) {
      list.add(buildCellHeader(
          flex: 1,
          text: (header.row3 != null) ? header.row3 : "#",
          textAlign: TextAlign.center));
    }
    if (widget.table.columns >= 4 && header.row4 != null) {
      list.add(buildCellHeader(
          flex: 1,
          text: (header.row4 != null) ? header.row4 : "#",
          textAlign: TextAlign.center));
    }
    if (widget.table.columns >= 5 && header.row5 != null) {
      list.add(buildCellHeader(
          flex: 1,
          text: (header.row5 != null) ? header.row5 : "#",
          textAlign: TextAlign.center));
    }
    if (widget.table.columns >= 6 && header.row6 != null) {
      list.add(buildCellHeader(
          flex: 1,
          text: (header.row6 != null) ? header.row6 : "#",
          textAlign: TextAlign.center));
    }
    if (widget.table.columns >= 7 && header.row7 != null) {
      list.add(buildCellHeader(
          flex: 1,
          text: (header.row7 != null) ? header.row7 : "#",
          textAlign: TextAlign.center));
    }
    if (widget.table.columns >= 8 && header.row8 != null) {
      list.add(buildCellHeader(
          flex: 1,
          text: (header.row8 != null) ? header.row8 : "#",
          textAlign: TextAlign.center));
    }
  ...
  Widget buildRow(Line line) {
    List<Widget> list = new List<Widget>();
    list.add(
        buildCellHeader(flex: 1, text: line.prefix, textAlign: TextAlign.left));
    list.add(Expanded(
        flex: 4,
        child: Row(
          children: [
            Image(
              image: CachedNetworkImageProvider(line.image),
              height: 15,
              width: 15,
            ),
            SizedBox(width: 5),
    ...
    if (widget.table.columns >= 1) {
      list.add(buildCell(
          flex: 1,
          text: (line.row1 != null) ? line.row1 : "#",
          textAlign: TextAlign.center));
    }
    if (widget.table.columns >= 2) {
      list.add(buildCell(
          flex: 1,
          text: (line.row2 != null) ? line.row2 : "#",
          textAlign: TextAlign.center));
    }
    if (widget.table.columns >= 3) {
      list.add(buildCell(
          flex: 1,
          text: (line.row3 != null) ? line.row3 : "#",
          textAlign: TextAlign.center));
    }
    if (widget.table.columns >= 4) {
      list.add(buildCell(
          flex: 1,
          text: (line.row4 != null) ? line.row4 : "#",
          textAlign: TextAlign.center));
    }
    if (widget.table.columns >= 5) {
      list.add(buildCell(
          flex: 1,
          text: (line.row5 != null) ? line.row5 : "#",
          textAlign: TextAlign.center));
    }
    if (widget.table.columns >= 6) {
      list.add(buildCell(
          flex: 1,
          text: (line.row6 != null) ? line.row6 : "#",
          textAlign: TextAlign.center));
    }
    if (widget.table.columns >= 7) {
      list.add(buildCell(
          flex: 1,
          text: (line.row7 != null) ? line.row7 : "#",
          textAlign: TextAlign.center));
    }
    if (widget.table.columns >= 8) {
      list.add(buildCell(
          flex: 1,
          text: (line.row8 != null) ? line.row8 : "#",
          textAlign: TextAlign.center));
    }
    ...
    return Container(
        ...
        decoration: BoxDecoration(
          color: (line.color == null)
              ? Colors.transparent
              : Color(int.parse("0xff" + line.color)).withOpacity(0.2),
          border: Border(
              top: BorderSide(
                  color: Theme.of(context)
                      .textTheme
