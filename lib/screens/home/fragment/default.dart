...
class _DefaultState extends State<Default> {
    ...
    FacebookInterstitialAd.loadInterstitialAd(
      ...
      listener: (result, value) {
        ...
        if (result == InterstitialAdResult.DISMISSED) {
          if (post_route != null) _isInterstitialAdLoaded = false;
          _loadInterstitialAd();
    ...
    _admobInterstitialAd ??= InterstitialAd(
      ...
      listener: AdListener(
        ...
        onAdClosed: (Ad ad) {
          ...
          _interstitialReady = false;
          createInterstitialAd();
          if (post_route != null) Navigator.push(context, post_route);
        },
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              if (postsList[index].id == -1) {
                return TeamTitleWidget(
                    applogo: _applogo,
                    appname: _appname,
                    appsubname: _appsubname);
                ...
                return Container(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return PlayerMiniWidget(
                          player: playersList[index], bgimage: _applogo);
                    },
                  ),
                );
  ...
  navigate(Post post, Function _postFavorite) async {
    switch (post.type) {
      case "youtube":
        post_route = MaterialPageRoute(
            builder: (context) =>
                YoutubeDetail(post: post, postFavorite: _postFavorite));
        break;
      case "video":
        post_route = MaterialPageRoute(
            builder: (context) =>
                VideoDetail(post: post, postFavorite: _postFavorite));
        break;
      default:
        post_route = MaterialPageRoute(
            builder: (context) =>
