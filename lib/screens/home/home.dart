...
class _HomeState extends ResumableState<Home> {
                  ...
                  body: SafeArea(
                    child: Column(
                      ...
                      children: [
                        ...
                        buildMenuItem(
                            "FAVORITES", Colors.lime, LineIcons.heart_o, () {
                          Route route = MaterialPageRoute(
                              builder: (context) => FavoriteList());
                          push(context, route);
                        }),
                        buildMenuItem("MY PROFILE", Colors.green,
                            LineIcons.user, goToProfil),
                        buildMenuItem(
                            "SETTINGS", Colors.indigoAccent, LineIcons.cog, () {
                          Route route = MaterialPageRoute(
                              builder: (context) => Settings());
                          push(context, route);
                        }),
                        buildMenuItem("RATE APP", Colors.orangeAccent,
                            LineIcons.star_half_o, rateApp),
                        buildMenuItem("LOG OUT", Colors.deepOrange,
                            LineIcons.sign_out, logout),
                        ClipRRect(
  ...
  void showGDPR() async {
    ...
    // Per tu shtuar pereseri, rregullo erroret
    GdprDialog.instance
        .showDialog(adsProvider.getAdmobPublisherId().toString(),
