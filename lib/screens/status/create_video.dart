...
class _CreateVideoState extends ResumableState<CreateVideo> {
  ...
  _pickVideo() async {
    ...
    File _local_video =await ImagePicker.pickVideo(source: ImageSource.gallery);
                                    ...
                                    child: ClipOval(
                                      child: Material(
                                        ...
                                        child: InkWell(
                                          ...
                                          child: SizedBox(width: 50, height: 50, child: Icon(LineIcons.close,color: Colors.white)),
                                          onTap: () {
                                            setState(() {
                                              _video =  null;
                                            });
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              SizedBox(height: 20),
                              Icon(LineIcons.angle_down, color: Colors.black)
                            ],
                          ),
                        ),
                      ),
                          ...
                          child: Container(
                              ...
                              ClipOval(
                                child: Material(
                                    ...
                                    InkWell(
                                      splashColor: Colors.white, // inkwell color
                                      child: SizedBox(width: 70, height: 70, child: Icon(LineIcons.video_camera,color: Colors.white)),
                                      onTap: () {
                                        _pickVideo();
                                      },
                                    )
  ...
  Future<String>  _submitVideo() async{
    if(logged){
      ...
      try {
        ...
        var request = new http.MultipartRequest("POST", Uri.parse(apiRest.submitVideo()));
