                                    ...
                                    child: InkWell(
                                      ...
                                      child: Row(
                                        ...
                                        children: <Widget>[
                                          ...
                                          Text(
                                            widget.status.comments.toString() +
                                                " Comments",
                                            style: TextStyle(
                                                color: Theme.of(context)
                                                    .textTheme
  ...
  void _reportImage() {
    Route route = MaterialPageRoute(
        builder: (context) => Report(
            message: "Report image :" + widget.status.description,
            image: Image.network(
              widget.status.image,
              fit: BoxFit.cover,
            ),
