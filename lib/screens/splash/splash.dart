...
class _SplashState extends State<Splash> {
  List<Post> favoritePostsList = List();
            ...
            Positioned(
                ...
                child: Center(
                  ...
                  children: [
                    CachedNetworkImage(
                      width: 90,
                      imageUrl: (widget.localapplogo == null ||
                              widget.localapplogo == "")
                          ? widget.applogo
                          : widget.localapplogo,
                      fit: BoxFit.fitWidth,
                    ...
                    SizedBox(height: 15),
                    Text(
                      (widget.localappname == null || widget.localappname == "")
                          ? widget.appname
                          : widget.localappname,
                      //widget.info,
                      style: TextStyle(
                    ...
                    Text(
                      (widget.localappsubname == null)
                          ? widget.appsubname
                          : widget.localappsubname,
                      style: TextStyle(
                          fontSize: 14,
              ...
              child: Column(
                children: [
                  CachedNetworkImage(
                    ...
                    imageUrl: (widget.localappsponsors == null ||
                            widget.localappsponsors == "")
                        ? widget.appsponsors
                        : widget.localappsponsors,
                    fit: BoxFit.fitWidth,
  ...
  Future<Match> _getMatch() async {
    ...
    if (statusCode == 200) {
      ...
      Route route = MaterialPageRoute(
          builder: (context) => MatchDetail(match: _match, back: false));
  ...
  Future<Post> _getPost() async {
    ...
    if (statusCode == 200) {
      ...
      switch (_post.type) {
        case "youtube":
          Route route = MaterialPageRoute(
              builder: (context) => YoutubeDetail(post: _post, back: false));
          Navigator.pushReplacement(context, route);
          break;
        case "video":
          Route route = MaterialPageRoute(
              builder: (context) => VideoDetail(post: _post, back: false));
          Navigator.pushReplacement(context, route);
          break;
        default:
          Route route = MaterialPageRoute(
              builder: (context) => PostDetail(post: _post, back: false));
          Navigator.pushReplacement(context, route);
          break;
      }
    } else {
  ...
  Future<Status> _getStatus() async {
    ...
    if (statusCode == 200) {
      ...
      switch (_status.kind) {
        case "image":
          Route route = MaterialPageRoute(
              builder: (context) => ImageDetail(status: _status, back: false));
          Navigator.pushReplacement(context, route);
          break;
        case "quote":
          Route route = MaterialPageRoute(
              builder: (context) => QuoteDetail(status: _status, back: false));
          Navigator.pushReplacement(context, route);
          break;
        default:
          Route route = MaterialPageRoute(
              builder: (context) => StatusDetail(status: _status, back: false));
          Navigator.pushReplacement(context, route);
          break;
      }
    } else {
  ...
  Future<void> getAppConfig() async {
    ...
    if (statusCode == 200) {
      ...
      setState(() {
        if (widget.appname != _app_name) widget.localappname = _app_name;

        if (widget.appsubname != _app_sub_name)
          widget.localappsubname = _app_sub_name;

        if (widget.applogo != _app_logo) widget.localapplogo = _app_logo;
      ...
      prefs.setString("android_ads_interstitial_facebook_id",
          response_android_ads_interstitial_facebook_id);
      prefs.setString("android_ads_interstitial_admob_id",
          response_android_ads_interstitial_admob_id);
      prefs.setString("android_ads_interstitial_type",
          response_android_ads_interstitial_type);
      prefs.setInt("android_ads_interstitial_click",
          response_android_ads_interstitial_click);
      prefs.setString("android_ads_banner_facebook_id",
          response_android_ads_banner_facebook_id);
      prefs.setString(
          "android_ads_banner_admob_id", response_android_ads_banner_admob_id);
      prefs.setString(
          "android_ads_banner_type", response_android_ads_banner_type);
      prefs.setString(
          "android_ads_native_admob_id", response_android_ads_native_admob_id);
      prefs.setString("android_ads_native_facebook_id",
          response_android_ads_native_facebook_id);
      prefs.setInt("android_ads_native_item", response_android_ads_native_item);
      prefs.setString(
          "android_ads_native_type", response_android_ads_native_type);
      prefs.setString(
          "android_admob_publisher_id", response_android_publisher_id);
      prefs.setString("android_admob_app_id", response_android_admob_app_id);

      // save ios ads ids in app

      prefs.setString("ios_ads_interstitial_facebook_id",
          response_ios_ads_interstitial_facebook_id);
      prefs.setString("ios_ads_interstitial_admob_id",
          response_ios_ads_interstitial_admob_id);
      prefs.setString(
          "ios_ads_interstitial_type", response_ios_ads_interstitial_type);
      prefs.setInt(
          "ios_ads_interstitial_click", response_ios_ads_interstitial_click);
      prefs.setString(
          "ios_ads_banner_facebook_id", response_ios_ads_banner_facebook_id);
      prefs.setString(
          "ios_ads_banner_admob_id", response_ios_ads_banner_admob_id);
      prefs.setString("ios_ads_banner_type", response_ios_ads_banner_type);
      prefs.setString(
          "ios_ads_native_admob_id", response_ios_ads_native_admob_id);
      prefs.setString(
          "ios_ads_native_facebook_id", response_ios_ads_native_facebook_id);
