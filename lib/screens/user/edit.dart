...
class _EditState extends State<Edit> {
  ...
  Future<String> _editProfile() async {
    ...
    if (logged) {
      ...
      try {
        var request =
            new http.MultipartRequest("POST", Uri.parse(apiRest.editProfile()));
        ...
        if (_image != null) {
          http.MultipartFile multipartFile =
              await http.MultipartFile.fromPath('uploaded_file', _image.path);
        ...
        if (image_user != "x") prefs.setString("IMAGE_USER", image_user);
